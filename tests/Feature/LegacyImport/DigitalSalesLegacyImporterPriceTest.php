...
test('digital sales import preserves price and currency', function () {
    $fixture = writeFixture_in_DigitalSalesLegacyImporterPrice();
...
function writeFixture_in_DigitalSalesLegacyImporterPrice(): string
{
