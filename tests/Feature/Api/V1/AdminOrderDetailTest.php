...
class AdminOrderDetailTest extends TestCase
{
    ...
    public function test_admin_order_show_includes_legacy_detail_fields(): void
    {
    ...
    public function test_admin_can_view_invoice_by_order_number(): void
    {
        $admin = User::query()->where('email', 'superadmin@selloff.test')->firstOrFail();
    ...
    public function test_admin_can_approve_guest_order_item(): void
    {
        $admin = User::query()->where('email', 'superadmin@selloff.test')->firstOrFail();
