...
class AdminBrandDepthTest extends TestCase
{
    ...
    public function test_admin_can_show_brand_with_categories_and_logo(): void
    {
    ...
    public function test_admin_can_search_brands_with_pagination(): void
    {
        $admin = User::query()->where('email', 'superadmin@selloff.test')->firstOrFail();
        Sanctum::actingAs($admin);
    ...
    public function test_admin_can_update_brand_categories_and_clear_logo(): void
    {
        $admin = User::query()->where('email', 'superadmin@selloff.test')->firstOrFail();
    ...
    public function test_admin_can_read_and_update_brand_settings(): void
    {
        $admin = User::query()->where('email', 'superadmin@selloff.test')->firstOrFail();
        Sanctum::actingAs($admin);
