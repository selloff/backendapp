...
class VendorPromotionInvoiceTest extends TestCase
{
    ...
    public function test_vendor_promotion_invoice_includes_pending_payment_details(): void
    {
    ...
    public function test_vendor_can_resume_pending_paystack_promotion_from_invoice_flow(): void
    {
        $vendor = User::query()->where('email', 'vendor@selloff.test')->firstOrFail();
