...
class BrandSettingsConsumerTest extends TestCase
{
    ...
    public function test_marketplace_preferences_expose_brand_settings(): void
    {
    ...
    public function test_public_brands_endpoint_is_empty_when_brands_disabled(): void
    {
        app(PlatformSettingsService::class)->upsertMany([
            'brand_status' => false,
        ], 'product');
    ...
    public function test_public_brands_endpoint_filters_by_category_ancestors(): void
    {
        app(PlatformSettingsService::class)->upsertMany([
            'brand_status' => true,
        ], 'product');
        ...
        $this->assertContains('Scoped Consumer Brand', $names);
        $this->assertNotContains('Other Consumer Brand', $names);
    }

    public function test_vendor_publish_requires_brand_when_not_optional(): void
    {
        app(PlatformSettingsService::class)->upsertMany([
            'brand_status' => true,
            'is_brand_optional' => false,
    ...
    public function test_vendor_can_publish_with_brand_when_not_optional(): void
    {
        app(PlatformSettingsService::class)->upsertMany([
            'brand_status' => true,
            'is_brand_optional' => false,
    ...
    public function test_draft_product_does_not_require_brand_when_not_optional(): void
    {
        app(PlatformSettingsService::class)->upsertMany([
            'brand_status' => true,
            'is_brand_optional' => false,
