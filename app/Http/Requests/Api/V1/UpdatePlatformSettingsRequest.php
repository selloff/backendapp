    ...
    private function rulesForGroup(string $group): array
    {
        return match ($group) {
            'email' => [
                ...
                'settings.mail_service' => ['sometimes', 'nullable', 'string', Rule::in(['mailtrap', 'smtp', 'mail', 'brevo', 'mailgun'])],
                'settings.mailtrap_mode' => ['sometimes', 'nullable', 'string', Rule::in(['auto', 'sandbox', 'sending'])],
                'settings.mailtrap_sandbox_username' => ['sometimes', 'nullable', 'string', 'max:255'],
                'settings.mailtrap_sandbox_password' => ['sometimes', 'nullable', 'string', 'max:255'],
                'settings.mailtrap_sending_username' => ['sometimes', 'nullable', 'string', 'max:255'],
                'settings.mailtrap_sending_password' => ['sometimes', 'nullable', 'string', 'max:255'],
                ...
                'settings.email_option_product_moderation' => ['sometimes', 'boolean'],
                'settings.email_option_new_order' => ['sometimes', 'boolean'],
                'settings.email_option_order_shipped' => ['sometimes', 'boolean'],
                'settings.email_option_refund' => ['sometimes', 'boolean'],
                ...
                'settings.email_option_new_message' => ['sometimes', 'boolean'],
                'settings.email_option_support_system' => ['sometimes', 'boolean'],
                'settings.email_option_welcome' => ['sometimes', 'boolean'],
                'settings.email_option_reset_password' => ['sometimes', 'boolean'],
                'settings.email_option_membership_purchase' => ['sometimes', 'boolean'],
                'settings.email_option_promotion_applied' => ['sometimes', 'boolean'],
                'settings.email_option_vendor_feedback' => ['sometimes', 'boolean'],
                'settings.email_option_membership_expiry' => ['sometimes', 'boolean'],
                'settings.email_option_escrow' => ['sometimes', 'boolean'],
